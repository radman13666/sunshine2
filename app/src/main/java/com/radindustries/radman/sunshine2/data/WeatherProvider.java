...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        //projection --- is the specified column in the database table
        //selection --- the thing u want
        //selectionArgs --- the values of the selection
        Cursor retCursor;
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        switch (match) {
            case WEATHER:
                db.beginTransaction();
                //appropriate for data that comes in in a block while processes are working on it
                int returnCount = 0;
                try {
