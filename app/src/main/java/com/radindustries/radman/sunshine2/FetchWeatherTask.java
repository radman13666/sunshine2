...
import com.radindustries.radman.sunshine2.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    public long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) { //throws NullPointerException
    ...
    private String[] getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                highAndLowStr = formatHighLows(high, low);
                resultStrs[i] = day + " - " + description + " - " + highAndLowStr;
            ...
            if ( cur.moveToFirst() ) {
                Log.d(LOG_TAG,"Size of the cursor from DB = "+cur.getCount());
			...
			for (int i = 0; i < cVVector.size(); i++) {
            	Log.v(LOG_TAG, "Weather data " + (i + 1) + ": " + cVVector.get(i).toString());
            }
            Log.d(LOG_TAG, "FetchWeatherTask Complete. " + cVVector.size() + " Inserted"); 

            return convertContentValuesToUXFormat(cVVector); //the result string array
    ...
    protected String[] doInBackground(String... params) {
        ...
        String units = "metric";
        int numDays = 14;
        String id = "e3d622935fa3b4ef335ed3c255059724";
